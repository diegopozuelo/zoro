...
## Structure
- `src/app/` — pages (Today at `page.tsx`, plus profile, pipeline, assistant, outreach, planner, journal, brainstorm, life, notes)
- `src/app/api/` — API routes (chat, plan, outreach, start-task, start-outreach, replan, day-summary)
...
## Database note
Tables include: profile, pipeline, conversations, messages, notes, leads, outreach_events, plan_items, plan_meta, priorities, journal, brainstorm, life_days, workouts. Ask before altering schema.